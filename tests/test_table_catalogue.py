...
# config-mutes was an M13 example but left the catalogue when the Mutes table became
# a bespoke editor (add form + right-justified Unmute), not a catalogue table.
@pytest.mark.parametrize(
    "table_id", ["workspace", "claude-plugins", "git-config-keys", "config-off"]
)
